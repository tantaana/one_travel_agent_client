                    ...
                    <div className='p-6 w-full lg:w-[800px]'>
                        {currentTab === undefined ?
                            <div className='flex items-center justify-between gap-6'>
                                <img src={teamData[0]?.img} className="w-[200px] lg:w-[300px] h-[300px] lg:h-[400px] object-cover rounded-xl" alt="" />
                                <div>
                                    ...
                                    <h2 className='text-base font-semibold'>{teamData[0]?.details}</h2>
                                </div>
                            </div>
                            :
                            <>{teamData.map((team, i) =>
