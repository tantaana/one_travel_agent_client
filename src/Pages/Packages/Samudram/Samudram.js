...
import samudram from '../../../Assets/samudram.webp'
    ...
    return (
        <div>
            <div className='packageImg mx-4 mb-32 lg:mx-10 py-40'>
                <h2 className='text-4xl md:text-5xl font-bold text-center my-10'>Samudram</h2>
            ...
            <div className='flex justify-center'>
                <div className='grid grid-cols-1 xl:grid-cols-3 2xl:grid-cols-4 gap-4 lg:gap-10 xl:gap-16 2xl:gap-10 mx-8 xl:mx-16 2xl:mx-20'>
                    <div className='xl:col-span-2 2xl:col-span-3'>
                        ...
                        <div className='mb-10'>
                            <img src={samudram} className="xl:w-11/12 2xl:w-5/6 object-cover" alt="" srcset="" />
                        </div>
                        ...
                        <div>
                            ...
                            <div className='flex gap-20 xl:w-11/12 2xl:w-5/6 mb-16'>
                                ...
                                <div className='pt-6'>
                                    <h2 className='text-xl font-semibold mb-4 uppercase'>Arrival At Samudram</h2>
                            ...
                            <div className='flex gap-20 xl:w-11/12 2xl:w-5/6 mb-16'>
                                ...
                                <div className='pt-6'>
                                    <h2 className='text-xl font-semibold mb-4 uppercase'>Samudram</h2>
                            ...
                            <div className='flex gap-20 xl:w-11/12 2xl:w-5/6 mb-16'>
                                ...
                                <div className='pt-6'>
                                    <h2 className='text-xl font-semibold mb-4 uppercase'>Departure from Samudram</h2>
                    ...
                    <div className='px-20 md:px-44 lg:px-80 xl:px-0 py-2'>
                        <div className='mb-10'>
                            <h2 className='text-center text-xl font-semibold mb-10'>Starting From <span className='text-2xl font-bold text-sky-700'>$35,299</span></h2>
                        ...
                        <div className='mb-6'>
                            ...
                            <input type="text" placeholder="Type here" value="Explore Samudram" className="input input-bordered border border-gray-500 w-full" />
                        </div>
                        ...
                        <div className='mb-6'>
                            ...
                            <input type="text" placeholder="Type here" value="Kolkata" className="input input-bordered border border-gray-500 w-full" />
                        </div>
