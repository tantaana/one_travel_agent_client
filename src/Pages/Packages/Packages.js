    ...
    return (
        <div class="dropdown inline-block relative">
            <button class="inline-flex items-center">
                <NavLink to='/packages' style={activeLinks}><span class="text-sm xl:text-base font-semibold hover:text-blue-500 ease-in-out duration-300 text-center flex items-center gap-1">Packages <MdOutlineArrowDropDown className='m-0 p-0' /></span></NavLink>
            </button>
